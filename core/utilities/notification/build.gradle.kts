...
android {
    namespace = "id.feinn.utility.notification"
...
mavenPublishing {
    coordinates(
        ...
        artifactId = mavenProperties.getProperty("artifactIdNotification"),
        version = mavenProperties.getProperty("version")
    )

    // Configure POM metadata for the published artifact
    pom {
        name.set("KMP Utilities Notification")
        description.set("FeinnNotification is a custom library that handle Notification for Android and iOS applications")
