...
public open class DefaultBufferedBlockCipher: BufferedBlockCipher {
    override var buf: ByteArray by Delegates.notNull()
    override var bufOff: Int by Delegates.notNull()

    override var forEncryption: Boolean by Delegates.notNull()
    override var cipher: BlockCipher by Delegates.notNull()
    override var mbCipher: MultiBlockCipher? = null

    override var partialBlockOkay: Boolean by Delegates.notNull()
    override var pgpCFB: Boolean by Delegates.notNull()

    protected constructor() : super()

    public constructor(cipher: BlockCipher): super() {
        this.cipher = cipher

        if (cipher is MultiBlockCipher) {
            this.mbCipher = cipher
            buf = ByteArray(mbCipher!!.getMultiBlockSize())
        } else {
            this.mbCipher = null
