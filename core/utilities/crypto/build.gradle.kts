...
android {
    namespace = "id.feinn.utility.crypto"
...
mavenPublishing {
    coordinates(
        ...
        artifactId = mavenProperties.getProperty("artifactIdCrypto"),
        version = mavenProperties.getProperty("version")
    )

    // Configure POM metadata for the published artifact
    pom {
        name.set("KMP Utilities Crypto")
        description.set("FeinnCrypto is a library to use cryptography in KMP projects")
